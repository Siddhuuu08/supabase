...
document.getElementById("contactForm").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const SUPABASE_URL = "https://vvumqayradmkvxpjezrf.supabase.co";
    const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ2dW1xYXlyYWRta3Z4cGplenJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzMDE0MTMsImV4cCI6MjA2MDg3NzQxM30.9xFa_Fkwyr6qGMcS5bA4FMIfyfCFGeW98dawxUSlvG8";
